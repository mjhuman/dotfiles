...
#+BEGIN_SRC emacs-lisp
	...
	;; 										:family "Menlo" :height (case system-type
	;; 																									('gnu/linux 130)
	;; 																									('darwin 220)) :weight 'normal)
...
#+RESULTS:
| ~/Dropbox/orgfiles/i.org | ~/Dropbox/orgfiles/arts.org | ~/Dropbox/orgfiles/words.org | ~/Dropbox/orgfiles/inbox.org |
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq dired-omit-mode t)
    ...
    (define-key global-map (kbd "M-6") 'dired-up-directory)
  ...
  (defun vmj/dictionary-define-word ()
    ...
    (let* ((word (vmj/dictionary-prompt))
      ...
      (with-output-to-temp-buffer buffer-name
        (shell-command (format "sdcv --data-dir /Applications/StarDict.app/Contents/Resources/share/stardict/dic -n %s" word) buffer-name))))
...
#+BEGIN_SRC emacs-lisp
      ...
      (global-set-key (kbd "\e\ec") (lambda () (interactive) (find-file "~/.emacs.d/ente.org")))
      ...
      (global-set-key (kbd "\e\ep") (lambda () (interactive) (find-file "~/fre/podcast/podcast.org")))
...
;    (define-key dired-mode-map (kbd "<SPC>") 'diredp-up-directory)
