...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "<f8>") 'read-only-mode)
  (set-default 'truncate-lines 0)
  (global-set-key (kbd "<C-f8>") 'toggle-truncate-lines)
  ;(global-set-key (kbd "C-A") 'beginning-of-buffer)
  ;(global-set-key (kbd "<C-E>") 'end-of-buffer)
  (global-set-key (kbd "C-<return>") '(lambda () funcall move-end-of-line funcall newline ))
#+END_SRC
...
#+END_SRC
* Stuff - Babel, projectile, smartparens, magit
#+BEGIN_SRC emacs-lisp
