...
(setq testornot "k")
 (let (fldr)
  ...
  (if (string-equal testornot "x") (setq fldr (concatenate 'string "matlab/resources/ModelAdvisor/en/" fldr ".xml")))

;(let (curdir, idx)
 ; (setq curdir (vmj/view-buffer-name))
 ; (setq idx (string-match-p (regexp-quote "matlab/") curdir))

 ; (if idx 
 ; (progn (find-file (substring curdir 0 idx)) (counsel-find-file fldr))
...
(global-set-key (kbd "\e\ey") (lambda () (interactive) (find-file "~/Dropbox/orgfiles/y.org")))
