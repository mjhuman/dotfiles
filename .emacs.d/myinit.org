...
(setq testornot "k")
 (let (fldr)
  (when (> (length where) 1)
  (progn 
  (setq testornot (substring where 0 1))
  ...
  ((string-equal where "b") (setq fldr "matlab/test/tools/slrtw/mdladv/"))
  ((string-equal where "c") (setq fldr "matlab/toolbox/simulink/simulink/modeladvisor/+ModelAdvisor/+Common/"))
  ((string-equal where "u") (setq fldr "matlab/toolbox/simulink/simulink/modeladvisor/+Advisor/+Utils/"))
  ((string-equal where "z") (setq fldr "matlab/test/toolbox/simulink/mdladv/UnitTests/Utils/")))

  (if (string-equal testornot "c") (setq fldr (concatenate 'string "matlab/toolbox/slcheck/" fldr "/@slCustomizer/private/")))
  (if (string-equal testornot "t") (setq fldr (concatenate 'string "matlab/test/toolbox/slcheck/" fldr)))
;  (if (string-equal testornot "x") (setq fldr (concatenate 'string "matlab/resources/ModelAdvisor/en/")))
  (if (string-equal testornot "x") 
  (find-file (concatenate 'string "matlab/resources/ModelAdvisor/en/" fldr ".xml"))
  (counsel-find-file fldr))


  ))

;; Model Advisor keybindings, hydra

(global-set-key
    (kbd "C-x w")
	    (defhydra coders (:color blue)
	      "modeladvisor"
	      ("m" (slcheck-goto "cm") "maab")
	      ("d" (slcheck-goto "cd") "do178b")
	      ("i" (slcheck-goto "ci") "iec61508")
	      ("tm" (slcheck-goto "tm") "t_maab")
	      ("td" (slcheck-goto "td") "t_do")
	      ("ti" (slcheck-goto "ti") "t_iec")
	      ("tu" (slcheck-goto "z") "t_utils")
	      ("xm" (slcheck-goto "xm") "x_maab")
	      ("xd" (slcheck-goto "xd") "x_do")
	      ("xi" (slcheck-goto "xi") "x_iec")
	      ("c" (slcheck-goto "c") "Common")
	      ("u" (slcheck-goto "u") "Utils")
	      ("b" (slcheck-goto "b") "baseline")
	      ("q" nil "cancel")))

(global-set-key
    (kbd "C-x p")
	    (defhydra perfours (:color blue)
	      "toggle"
	      ("a" (p4-add) "add")
	      ("e" (p4-edit) "edit")
	      ("r" (p4-revert) "revert")
	      ("d" (p4-delete) "delete")
	      ("o" (slcheck-goto ) "opened")
	      ("q" nil "cancel")))
...
(global-set-key (kbd "\e\eg") (lambda () (interactive) (find-file "~/house/orgfiles/guidelines.org")))
(global-set-key (kbd "\e\em") (lambda () (interactive) (find-file "~/house/orgfiles/mw.org")))
